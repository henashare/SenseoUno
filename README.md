...
#### <div align=justify>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<ins>Note :</ins> La bibliothèque est implémentée pour être utilisée à partir d'une carte Arduino Uno. Elle est faite pour être plus rapide que la bibliothèque Arduino lors de l'exécution du programme, d'où sa non-portabilité. En revanche, le référencement aux différents ports et registres est masqué par la bibliothèque. L'utilisateur "classique" ne sera donc pas dépaysé, et pourra coder son programme comme n'importe quel programme Arduino. L'exécution du code sera plus rapide que la bibliothèque Arduino (certains diront que le langage Arduino). Néanmoins, ce gain de rapidité implique que la bibliothèque n'est pas utilisable sur toutes les cartes. Bien que ce ne soit pas à l'ordre du jour, d'autres bibliothèques du même type pourraient voir le jour tôt ou tard afin de pouvoir exporter le même code sur d'autres cartes.</div>
<div align=justify>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;L'implémentation de la bibliothèque est disponible dans les fichiers sources contenus dans le dossier src : SenseoUno.h et SenseoUno.cpp.
