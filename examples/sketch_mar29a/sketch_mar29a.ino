...
void loop()
{
  Senseo.activateRGB(1, 0, 1);
  while(Senseo.isCountdown() == false) {Serial.println("A"); if(Senseo.isCountdown()) break;}
  Senseo.activateRGB(0, 1, 0);
  while(Senseo.isCountdown() == false) {Serial.println("B"); if(Senseo.isCountdown()) break;}
  Senseo.activateRGB(0, 0, 1);
  while(Senseo.isCountdown() == false) {Serial.println("C"); if(Senseo.isCountdown()) break;}
  Senseo.activateRGB(1, 0, 0);
  while(Senseo.isCountdown() == false) {Serial.println("D"); if(Senseo.isCountdown()) break;}
  Senseo.activateRGB(1, 1, 0);
  while(Senseo.isCountdown() == false) {Serial.println("E"); if(Senseo.isCountdown()) break;}
  Senseo.activateRGB(0, 1, 1);
  while(Senseo.isCountdown() == false) {Serial.println("F"); if(Senseo.isCountdown()) break;}
  Senseo.activateRGB(1, 1, 1);
  while(Senseo.isCountdown() == false) {Serial.println("G"); if(Senseo.isCountdown()) break;}
}
